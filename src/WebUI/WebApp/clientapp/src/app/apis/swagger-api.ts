...
export class ViewMeetingClient {
    ...
    put(meetingId: number, meetingId: number | undefined, govbodyName: string | null | undefined, locationName: string | null | undefined, date: string | null | undefined, topics: ViewMeetingTopic_Dto[] | null | undefined, speakers: ViewMeetingSpeaker_Dto[] | null | undefined, sections: ViewMeetingSection_Dto[] | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/ViewMeeting/{meetingId}?";
        if (meetingId === undefined || meetingId === null)
            throw new Error("The parameter 'meetingId' must be defined.");
        url_ = url_.replace("{meetingId}", encodeURIComponent("" + meetingId));
    ...
    getGovLocation(id: number): Observable<GovLocationDetails_Dto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<GovLocationDetails_Dto>><any>_observableThrow(response_);
        }));
    }
